...
# Freestanding x86_64 ET_EXEC + embed into Rust for `run` / `echo`
userland: ${USERLAND_SRC} ${USERLAND_LD} ${USERLAND_ECHO_SRC}
	$(call require_tool,$(NASM),nasm)
	$(call require_tool,$(LD),ld)
	...
	@echo -e "$(BOLD)$(GREEN)[✓] USERLAND hello+echo embedded$(RESET)"
