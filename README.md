...
4. **Phase 9** — grow the Linux surface (dynlink / `PT_INTERP` next)  
...
**Phase 9a–9e** in: symlink/statx, file mmap, poll/epoll, execveat/prctl, **file-map ELF + `MAP_SHARED` writeback**. Next: dynlink (P10).  
