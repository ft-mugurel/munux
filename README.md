...
4. **Phase 9–11** — Linux surface; **P10a–d** dynlink + **P11a–d** terminals / job control  
5. **linuxkpi** — compile Linux driver `.c` ([docs/LINUXKPI.md](docs/LINUXKPI.md)); not distro `.ko` blobs  
6. **Later** — sockets, graphics+input, **installable desktop**
...
**Phase 9a–9e** in; **P10a–d** dynlink; **P11a–d** `jobtest` / `ptytest` / `n_ttytest` / `jobstoptest`. Next: P12 sockets.  
